const apiKey = "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"
...
//CORS 이슈 해결 (cors옵션을 넣어주는 것) -> 내 사이트만 요청을 받게 만드는 것
let corsOptions = {
    origin: 'https://chatdoge-8d3.pages.dev', // 내 프론트엔드 주소
    credentials: true
}
